...
\COPY adjectives(ru, en) FROM '/tmp/ready_adjectives.csv'
DELIMITER ',' CSV HEADER;

\COPY nouns(ru, en) FROM '/tmp/ready_nouns.csv'
DELIMITER ',' CSV HEADER;

\COPY others(ru, en) FROM '/tmp/ready_others.csv'
DELIMITER ',' CSV HEADER;

\COPY verbs(ru, en) FROM '/tmp/ready_verbs.csv'
DELIMITER ',' CSV HEADER;
